...
B = 8.0 # Right end point
const Δt = 0.1 # Step size
const T = 250 # Number of time steps

# Filament parameters
N = 20 # Number of actin filaments, use odd number to ensure they do not visually overlap with focal adhesions
...
α = 0.001 # Probability filament turns over
...
const β = 0.001 # Probability motor detaches per second
