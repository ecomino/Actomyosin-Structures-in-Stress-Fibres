Base.@kwdef mutable struct Parameters
    ...
    T::UInt16 = 10 # Number of time steps
    ...
    α::Float64 = 0.001 # Probability filament turns over

    # Motor parameters
    M::UInt16 = 10 # Maximum number of myosin motors
    motors::UnitRange{UInt16} = N+1:N+M # Indexes of motors
    λ::UInt16 = floor(Int,0.75*M) # Average number of motors currently attached
    β::Float64 = 0.001 # Probability motor turns over
    ...
    ξ::Float64 = 0.0000001 # Drag on filaments due to moving through the cytoplasm (think about units!)
    ...
    ρ::Float64 = 10.0 # Drag on filaments due to climbing through extracellular matrix (think about units!)
